...
import xiaojinzi.android.view.advView.AdvView;
import xiaojinzi.java.util.DateUtil;
...
public class HomeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void setOnListener() {
        ...
        //设置弹出式小菜单的点击监听
//        sm_menu.setOnClickListener(this);
//        sm_menu.setOnMenuCloseListener(this);
    }
     ...
     * 2.夜晚模式
     */
    private void loadShowMode() {
        int mode = SPUtil.get(getActivity(), Constant.SP.homeFragment.themeMode, 0);
        onEventChangeMode(mode);
    }
    ...
    public void onResume() {
        super.onResume();
        int mode = SPUtil.get(getActivity(), Constant.SP.common.showMode, 0);
        onEventChangeMode(mode);
        if (av != null) {
            av.startAutoChange();
        }
