...
import xiaojinzi.android.util.os.SystemUtil;
...
public class DetailActivity extends BaseFragmentActivity {
    ...
    public void initView() {
        ...
        if (!bb) {
            ActivityUtil.startActivity(this, DetailTipActivity
                    .class);
        }
    }
    ...
    public void viewClick(View v) {
        ...
        if (id == R.id.iv_act_detail_back) {
            ...
            startActivity(i);
        } else if (id == R.id.iv_act_detail_share) {
            SystemUtil.shareMsg(this, "分享", "提示", "您好", null);
        }
    }
    ...
    public void onEventChangeTitleBarOpacity(Integer top) {
        if (top < 2 * titleBarHeight) {
            float percent = top / new Float(titleBarHeight);
            rl_titlebar.setAlpha(1 - percent / 8);
